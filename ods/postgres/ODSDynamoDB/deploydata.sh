...
app_role="odsdynamodb_app_role_${stagename}"
app_user="odsdynamodb_app_user_${stagename}"
db="odsdynamodb_${stagename}"
...
function grantPermissionToSchema {
    ...
    ALTER DEFAULT PRIVILEGES FOR USER '${2}' IN SCHEMA '$1' GRANT ALL ON TABLES TO '${2}';
...
grantPermissionToSchema "raw" "${app_role}"
grantPermissionToSchema "stg" "${app_role}"
