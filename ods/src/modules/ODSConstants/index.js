export const DataPipeLineTaskConfigNameEnum = {
  ...
  JSONHistoryDataToJSONSchema: { value: 2, name: 'JSON History Data to JSON Schema', Parent: 1, ParentName: 'ProcessJSONToPostgres' },
  JSONHistoryToFlatJSON: { value: 3, name: 'JSON History to Flat JSON', Parent: 1, ParentName: 'ProcessJSONToPostgres' },
  FlatJSONToCSV: { value: 4, name: 'Flat JSON to CSV', Parent: 1, ParentName: 'ProcessJSONToPostgres' },
  CSVToPrestage: { value: 5, name: 'CSV to Pre-stage', Parent: 1, ParentName: 'ProcessJSONToPostgres' },
  PreStagetoRAW: { value: 6, name: 'Pre-Stage to RAW', Parent: 1, ParentName: 'ProcessJSONToPostgres' },
