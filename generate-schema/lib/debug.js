...
console.log("Without enums but with Popular Format", JSON.stringify(schemaWithPopFormat, null, 2));

// test adding format counts
const schemaWithCounts = generateSchema.json("Person", persons, {
  addFormatCounts: true
});
console.log("Without enums but with Format Counts", JSON.stringify(schemaWithCounts, null, 2));
