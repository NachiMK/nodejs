...
const get = exports.get = (0, _warewolf2.default)(_beforeAfterMiddleware.before, (0, _validatorMiddleware.validateParams)(require('./request.schema.json')), (0, _roleAuthorizerMiddleware.isRoleAuthorized)([_rolePolicy.ROLE_PLATFORM_HIXME_ADMIN]), (0, _dynamoMiddleware.getDynamoItem)({
  tableName: 'services',
