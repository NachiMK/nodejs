...
CREATE TABLE IF NOT EXISTS public.stage_planrates_rp502_oh_20180509 AS
SELECT
 p."State" as "State"
,p."Year" as "plan_year"
...
,p."Metal" as "level"
,p."IsHSA" as "HSA"
,p."UseForModeling" as "use_for_modeling" 
...
SELECT * FROM public.stage_planrates_rp502_oh_20180509;
