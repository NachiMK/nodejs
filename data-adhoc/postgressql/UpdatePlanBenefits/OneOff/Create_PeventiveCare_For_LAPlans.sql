CREATE TABLE public."stage_LA_Missing_PreventiveCare" AS 
...
AND     "State" = 'LA' AND "Year" = 2018 AND "IsForSale" = true
;

-- SELECT * FROM "PlanBenefits" WHERE "Benefit" = 'PeventativeCare'

SELECT * FROM public."stage_LA_Missing_PreventiveCare"
...
INSERT INTO
    ...
    CROSS JOIN public."stage_LA_Missing_PreventiveCare" as T
...
-- Commit if # of rows updated is 35
COMMIT;