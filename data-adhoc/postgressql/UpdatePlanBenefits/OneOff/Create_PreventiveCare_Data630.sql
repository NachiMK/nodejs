CREATE TABLE public."stage_2019_Missing_PreventiveCare_data630" AS 
...
SELECT * FROM public."stage_2019_Missing_PreventiveCare_data630"
...
INSERT INTO
    ...
    CROSS JOIN public."stage_2019_Missing_PreventiveCare_data630" as T
...
SELECT "Year", "HiosPlanID" FROM public."stage_2019_Missing_PreventiveCare_data630" T
