CREATE TABLE public."stage_2019_Missing_PreventiveCare_data660" AS 
...
SELECT * FROM public."stage_2019_Missing_PreventiveCare_data660"
...
INSERT INTO
    ...
    CROSS JOIN public."stage_2019_Missing_PreventiveCare_data660" as T
...
SELECT "Year", "HiosPlanID" FROM public."stage_2019_Missing_PreventiveCare_data660" T
WHERE 1 = (SELECT COUNT(*) FROM "PlanBenefits" WHERE T."HiosPlanID" = "HiosPlanID" and "Year" = T."Year")
AND EXISTS (SELECT 1 FROM "PlanBenefits" WHERE T."HiosPlanID" = "HiosPlanID" and "Year" = T."Year" AND "Benefit" = 'PreventiveCare')
