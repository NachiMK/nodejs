...
CREATE TABLE public."PlanBenefits_Data658_BAK" AS 
...
FROM    public."PlanBenefits_Data658_BAK" AS S
...
WHERE   1 = 1
and     PB."Year" = 2019
AND     EXISTS (SELECT 1 FROM public."PlanBenefits_Data658_BAK" AS S WHERE S."PlanBenefitID" = PB."PlanBenefitID")
