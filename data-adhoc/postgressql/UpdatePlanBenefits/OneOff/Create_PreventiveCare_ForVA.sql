CREATE TABLE public."stage_VA_Missing_PreventiveCare" AS 
...
AND     "State" = 'VA' AND "Year" = 2018 AND "IsForSale" = true
;

-- SELECT * FROM "PlanBenefits" WHERE "Benefit" = 'PeventativeCare'

SELECT * FROM public."stage_VA_Missing_PreventiveCare"
...
INSERT INTO
    ...
    CROSS JOIN public."stage_VA_Missing_PreventiveCare" as T
