...
CREATE TABLE public."PlanBenefits_Data619_BAK2" AS 
...
FROM    public."PlanBenefits_Data619_BAK2" AS S
...
WHERE   1 = 1
and     PB."Year" = 2019
AND     EXISTS (SELECT 1 FROM public."PlanBenefits_Data619_BAK2" AS S WHERE S."PlanBenefitID" = PB."PlanBenefitID")
