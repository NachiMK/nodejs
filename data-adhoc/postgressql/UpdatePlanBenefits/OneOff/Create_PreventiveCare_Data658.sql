CREATE TABLE public."stage_2019_Missing_PreventiveCare_data658" AS 
...
SELECT * FROM public."stage_2019_Missing_PreventiveCare_data658"
...
INSERT INTO
    ...
    CROSS JOIN public."stage_2019_Missing_PreventiveCare_data658" as T
...
SELECT "Year", "HiosPlanID" FROM public."stage_2019_Missing_PreventiveCare_data658" T
