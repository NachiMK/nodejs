...
psql -h rds.amazonaws.com -p 5432 -U ${user} -d plans_${stagename} -c "\copy (SELECT * FROM udf_Report_PlanBenefits($year, '$state')) TO $csvReportFile WITH DELIMITER ',' null as '' CSV HEADER"
